...
Speech Hub is a simple and static command line blog engine. It allows you to create posts and publish then through your domain.

What do you mean about 'command line'?
--------------------------------------

On Speech Hub you are able to create posts, publish then, modify, remove, etc. all using just you *nix command line. You don't need to access a web browser to do it. All you need is Speech Hub, a text editor (doesn't matter the flavor), and a tool to publish the content to your server.
